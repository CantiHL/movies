...
class ActorsController extends Controller
{
    ...
    public function index($page=1)
    {
        ...
        $viewModal=new ActorsViewModel($popularActors,$page);
        return view('actors.index',$viewModal);
    }
    ...
    public function show(string $id)
    {
        ...
        //dd($movie);
        $viewModal=new ActorViewModel($actor,$social,$credits);
        return view('actors.show',$viewModal);
    }
