<div class="relative mt-3 md:mt-0" x-data="{isOpen:true}" @click.away="isOpen=false">
    <input wire:model.debounce.1000ms="search" id="search" type="text" class="bg-gray-800 rounded-full text-sm w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-ouline" placeholder="Search"
           x-ref="search"
           @keydown.window="
    ...
    <div class="absolute top-0 left-0">
        <i class="fill-current ti-search w-4 text-gray-500 ml-2 mt-1"></i>
    </div>
    <div wire:loading class="absolute spinner top-0 right-0 mr-1">
        <div role="status">
